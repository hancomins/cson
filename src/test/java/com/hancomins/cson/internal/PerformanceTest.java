...
public class PerformanceTest {
    ...
    public static void main(String[] args) {
       ...
       // if(1 < 2) return;
        ...
        CSONObject rootObject , prevObject = new CSONObject();
        rootObject = prevObject;
        long startX = System.currentTimeMillis();
        for(int i = 0; i < 10000000; ++i) {

            CSONObject csonObject = new CSONObject();
            prevObject.put("key", csonObject);
            prevObject = csonObject;
        }
        long endX = System.currentTimeMillis();
        System.out.println("Time: " + (endX - startX) + "ms");
        ...
        startX = System.currentTimeMillis();
        CSONObject jsonObject = new CSONObject(rootObject.toString());
        endX = System.currentTimeMillis();
        System.out.println("Time: " + (endX - startX) + "ms");
