...
public class JSON5ParserTest  {
    ...
    public void testUnquoted() {
        ...
        System.out.println(csonObject.toString());
        assertEquals(csonObject.get("singleQuoted"), "and_you_can_quote_me_on_that\"");
    ...
    public void testConsecutiveCommas() {
            ...
            assertEquals(" 이 값은 어디에 ", csonObject.getCommentForValue("nullValue"));
            ...
            try {
                csonObject = new CSONObject(json, ParsingOptions.json5().setAllowConsecutiveCommas(false));
                assertEquals("are just fine", csonObject.optString("consecutiveCommas"));
                fail();
            } catch (Exception e) {
    ...
    public void testCSONArray() {
        ...
        CSONArray csonArray = new CSONArray(array, ParsingOptions.json5());
    ...
    public void testComplexJson5Parsing() {
        ...
        CSONObject csonObject = new CSONObject(complexJson5);
        ...
        for(int c = 0; c < cycle; ++c) {
            ...
            if(csonTest) {
                ...
                for (int i = 0; i < testCaseInCycle; i++) {
                    CSONObject csonObject1 = new CSONObject(testData, ParsingOptions.json5());
                }
